...
import rentaautos.fx.ReporteFacturasViewer;
...
public class MainController implements Initializable, AbrirFormularioCallback {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        if (!RentaAutosFX.isSplashLoaded) {
            loadSplashScreen();
        }
    
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/rentaautos/fx/Menu/sidepanel.fxml"));
    ...
    private void loadSplashScreen() {
        try {
            RentaAutosFX.isSplashLoaded = true;

            pane = FXMLLoader.load(getClass().getResource(("/rentaautos/fx/Menu/splash.fxml")));
            ...
            fadeOut.setOnFinished((e) -> {
                try {
                    AnchorPane parentContent = FXMLLoader.load(getClass().getResource(("/rentaautos/fx/Menu/main.fxml")));
    ...
    public void abrirFormulario(String nombreFormulario) {
        try {
            ...
            switch(nombreFormulario){
                ...
                case "Reporte de Automoviles":
                    nombreFxml= "FormReporteAutos.fxml";
                    break;
